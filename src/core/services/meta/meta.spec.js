describe('$$mdMeta', function() {
  ...
  describe('set meta', function () {
    ...
    it('should create the element and append it to the body', inject(function($$mdMeta) {
      var name = 'test';
      var content = 'value';
    ...
    it('should update the existing meta tag', inject(function($$mdMeta) {
      var name = 'test';
      var content = 'value';
    ...
    it('should map existing meta tag', inject(function($$mdMeta) {
      var name = 'test';
      var content = 'value';
    ...
    it('should return a remove function', inject(function($$mdMeta) {
      var name = 'test';
      var content = 'value';
  ...
  describe('get meta', function () {
    ...
    it('should return the meta content', inject(function($$mdMeta) {
      var name = 'test';
      var content = 'value';
    ...
    it('should reject unavailable meta tags', inject(function($$mdMeta) {
      var name = 'test';
    ...
    it('should add not mapped meta tag to the hashmap', inject(function($$mdMeta) {
      var name = 'test';
      var content = 'value';
